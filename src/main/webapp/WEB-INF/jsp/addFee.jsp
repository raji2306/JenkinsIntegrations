		...
		<div class="card mb-3 text-center"
			...
			<div class="row">
				<div class="col-md-4" style="margin: auto">
					<form:form action="/admin/saveFee" modelAttribute="fee"
						method="post" commandName="fee">
						<form:label path="feeName" style="float : left;">Fee Name</form:label>
						<form:input type="text" class="form-control"
							placeholder="Fee name" aria-label="First Name" path="feeName"
							id="feeName" style="background-color: transparent; border-radius: 25px; box-shadow: 0 0 17px #fff;" required="required" />
						<br>
						...
						<form:input type="number" class="form-control"
							placeholder="Amount" aria-label="Amount" id="amount"
							path="amount" style="background-color: transparent; border-radius: 25px; box-shadow: 0 0 17px #fff;" required="required" />
						<br>
						<form:label path="dueDate" style="float : left;">Due Date</form:label>
						<form:input type="date" class="form-control"
							placeholder="Due Date" aria-label="Due Date" id="dueDate"
							path="dueDate" style="background-color: transparent; border-radius: 25px; box-shadow: 0 0 17px #fff;" required="required" />
						<br>
