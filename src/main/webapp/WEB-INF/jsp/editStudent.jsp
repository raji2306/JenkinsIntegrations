...
<body>
	...
	<div class="container">
		<h5>Add Student</h5>
		<div class="card mb-3"
			style="width: 80rem; height: 30rem; padding: 2px ;background-color:transparent;border-radius: 25px; box-shadow: 0 0 17px #fff;">
			<br>
			<br>
			<form:form action="/admin/updateStudent" modelAttribute="student"
				method="post" commandName="student">
				<div class="row">
					<div class="col">
						<form:input type="hidden" path="studId" />
						<form:input type="text" class="form-control"
							placeholder="First name" aria-label="First Name" path="firstName"
							id="firstName" required="required" />
					</div>
					<div class="col" style="border-right: 1px solid black;">
						<form:input type="text" class="form-control"
							placeholder="Last name" aria-label="Last Name" path="lastName"
				...
				<div class="row">
					...
					<div class="col-md-4">
						<form:input type="number" class="form-control" placeholder="RRN"
							aria-label="RRN" id="rrn" path="rrn" required="required" />
					</div>
					...
					<div class="col" style="border-right: 1px solid black;">
						...
						<form:input type="date" id="dob" path="dob" required="required" />
					</div>

					<div class="col-md-4">
						<form:input type="email" class="form-control" placeholder="Email"
							aria-label="Email" id="email" path="email" required="required" />
					</div>
				...
				<div class="row">
					<div class="col">
						<form:input type="text" class="form-control" placeholder="Class"
							aria-label="Class" id="uniClass" path="uniClass"
							required="required" />
					</div>
					<div class="col" style="border-right: 1px solid black;">
						<form:input type="text" class="form-control" placeholder="Section"
							aria-label="Section" id="section" path="section"
							required="required" />
					</div>
					<div class="col">
						<form:input type="number" class="form-control" placeholder="Phone"
							aria-label="Phone" id="phone" path="phone" required="required" />
					</div>
				</div>
                ...
                Male
						...
						<div class="form-check">
							<form:radiobutton class="form-check-input" value="female"
								path="gender" id="female" checked="checked" />
                ...
                Female
					...
					<div class="col" style="border-right: 1px solid black;">
						<div class="form-check">
							<form:radiobutton class="form-check-input" value="yes"
								path="scholarship" id="yes" />
							<form:label class="form-check-label" path="scholarship" for="yes">
                  Yes
                </form:label>
						</div>
						<div class="form-check">
							<form:radiobutton class="form-check-input" value="no"
								path="scholarship" id="no" checked="checked" />
					...
					<div class="col">
						<div class="form-floating">
							<form:textarea id="address" path="address"
								...
								placeholder="Type Flat no, Street name, Locality, Area, City, Pincode"
				...
				<div class="row">
                  ...
                  Hostel
						...
						<div class="form-check">
							<form:checkbox class="form-check-input" id="transport"
								path="transport" />
							<form:label class="form-check-label" path="transport"
								for="Transport">
                  Transport
                </form:label>
						</div>
						<div class="form-check">
							<form:checkbox class="form-check-input" id="canteen"
								path="canteen" />
                  ...
                  Canteen
					...
					<div class="col text-center"
						style="margin-left: -220px; border-right: 1px solid black;">
						<form:label class="form-check-label" path="scholarshipPercent"
							for="scholarshipPercent">
                  Scholarship Percent
              </form:label>
						<form:input type="text" class="form-control"
							placeholder="Type Scolarship Percent"
							aria-label="scholarshipPercent" id="scholarshipPercent"
