...
<body>
	...
	<div class="container text-center">
		<div class="row g-3">
			...
			<div class="col-md-4">
				<form class="d-flex" action="/admin/searchStudent">
					<input class="form-control me-2" type="search"
						placeholder="Search Student" aria-label="Search" name="keyword"
						id="keyword">
			...
			<tbody>
				<c:forEach items="${studentlist}" var="students">
					<tr>
						...
						<td>${students.rrn}</td>
						<td><a href="/admin/deletestudentbyid/${students.studId }">
								<button type="button" class="btn btn-secondary">Delete</button>
						</a> <a href="/admin/editstudent/${students.studId }">
